const queries = {
	select: {
		...
		getContactURL: "SELECT url FROM url WHERE contact_id = $1 AND user_id = $2",
	...
	insert: {
		...
		insertContactPhone: "INSERT INTO contact_phone (user_id, contact_id, phone_type, phone_code, phone_number) VALUES ($1, $2, $3, $4, $5)",
		insertContactEmail: "INSERT INTO contact_email (user_id, contact_id, email_type, email_direction) VALUES ($1, $2, $3, $4)",
		insertContactURL: "INSERT INTO urls (user_id, contact_id, url) VALUES ($1, $2, $3)",
		insertContactDate: "INSERT INTO contact_date (user_id, contact_id, date_type, contact_date) VALUES ($1, $2, $3, $4)",
	},
	update: {
		updateContact:
			"UPDATE contact SET first_name = $1, last_name = $2, contact_alias = $3, company = $4, address = $5 WHERE id = $6 AND user_id = $7",
		updateContactPhone: "UPDATE contact_phone SET phone_type = $1, phone_code = $2, phone_number = $3 WHERE contact_id = $4 AND user_id = $5",
		updateContactEmail: "UPDATE contact_email SET email_type = $1, email_direction = $2 WHERE contact_id = $3 AND user_id = $4",
		updateContactURL: "UPDATE url SET url = $1 WHERE contact_id = $2 AND user_id = $3",
		updateContactDate: "UPDATE contact_date SET date_type = $1, contact_date = $2 WHERE contact_id = $3 AND user_id = $4",
	...
	delete: {
		...
		deleteContactPhone: "DELETE FROM contact_phone WHERE contact_id = $1 AND user_id = $2",
		deleteContactEmail: "DELETE FROM contact_email WHERE contact_id = $1 AND user_id = $2",
		deleteContactURL: "DELETE FROM url WHERE contact_id = $1 AND user_id = $2",
		deleteContactDate: "DELETE FROM contact_date WHERE contact_id = $1 AND user_id = $2",
